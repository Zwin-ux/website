        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-4">
                  <h3 className="text-xl md:text-2xl font-semibold text-white line-through decoration-red-500/50">
                    FIBO Hackathon
                  </h3>
                  <span className="bg-red-500/10 text-red-500 text-xs font-bold px-3 py-1 rounded-full border border-red-500/20 tracking-wide uppercase">
                    ENDED
                  </span>
                </div>
                <p className="text-white/50 leading-relaxed text-sm md:text-base mb-3 line-through">
